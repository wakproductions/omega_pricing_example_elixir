defmodule TelnyxOmegaPricing.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import TelnyxOmegaPricing.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&TelnyxOmegaPricing.ErrorHelpers.translate_error/1)
